...
public class FirstNameController {
    ...
    public ArrayList<String> getAll() {
        ArrayList<String> allMiddleAndLastName = WebClient.create("http://mname:8082")
            .get()
            .uri("/student/get")
            .retrieve()
    ...
    public Student getById(@PathVariable("id") String id) {
        Student student = WebClient.create("http://mname:8082")
            .get()
    ...
    public String addFirstName(@RequestBody Student student) {
    	...
    	//помiняти локалхоста+
        String id = WebClient.create("http://mname:8082")
            .post()
            .uri("/student/add")
    ...
    public String updateById(@RequestBody Student student, @PathVariable("id") String id) {
        String result = WebClient.create("http://mname:8082")
            .put()
